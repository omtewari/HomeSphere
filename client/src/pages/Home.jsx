  ...
  useEffect(() => {
    const fetchListings = async () => {
      try {
        ...
        console.log('OFFER LISTINGS RESPONSE:', offerData);
        ...
        console.log('RENT LISTINGS RESPONSE:', rentData);
        ...
        console.log('SALE LISTINGS RESPONSE:', saleData);
    ...
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
         HomeLY is the best place to find your next perfect place to live.
          <br />
      ...
      {offerListings.length > 0 && (
        <Swiper navigation loop={false} slidesPerView={1}>
          {offerListings.map((listing) => (
            <SwiperSlide key={listing._id}>
              <div
                style={{
                  background: `url(${listing.imageUrls?.[0] || '/fallback.jpg'}) center no-repeat`,
